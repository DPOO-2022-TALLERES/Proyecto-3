...
public class showReport {
	...
	//Muestra el porcentaje de los integrantes
	 ...
	 public void ProyectStats(Proyecto Proy) {
		 ...
		 ArrayList<Actividad> actividades = Proy.getActividades();
		 ...
		 int totalesAct = actividades.size();
		 int tiempoTrans= calTiempoTras(actividades)*100/tiempoFinEst;
		 int hechasAct = getActividadesHechas(Proy)*100/totalesAct;
		 System.out.println(tiempoTrans + "   " + tiempoFinEst + "  "+ calTiempoTras(actividades));
	 ...
	 public int calTiempoTras(ArrayList<Actividad> actividades) {
		 ListIterator<Actividad> lt = actividades.listIterator();
		 int cont  =0;
			 
		 while (lt.hasNext()) {
			 Actividad temp = lt.next();
			 cont += Integer.parseInt(temp.getMinutos().strip());
		 }
		return cont;
	 ...
	 public void grapToGoalDate(ArrayList<Actividad> tasks) {
		 List<String> xData = new ArrayList<String>();
		 List<Integer> yData = new ArrayList<Integer>();
		 ListIterator<Actividad> it = tasks.listIterator();
		 
		 while (it.hasNext()) {
			 Actividad task = it.next();
			 String temp = task.getHoraFin();
			 String name = task.getTitulo();
